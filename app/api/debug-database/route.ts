...
export async function GET(request: NextRequest) {
    ...
    try {
        ...
        try {
            ...
            console.log(
                'User collection documents count:',
                userCollectionDocs.documents.length
            );
        } catch (userCollError) {
        ...
        const testDocData = {
            ...
            dwollaCustomerUrl:
                'https://api-sandbox.dwolla.com/customers/test-customer-id',
        };

        try {
            console.log(
                'Attempting to create test document with data:',
                testDocData
            );
            ...
            try {
                ...
                console.log(
                    'Test document cleanup failed (not critical):',
                    cleanupError
                );
            }
