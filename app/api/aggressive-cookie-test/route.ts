...
export async function POST(request: NextRequest) {
    try {
        ...
        try {
            ...
            console.log('[AGGRESSIVE-COOKIE-TEST] Method 1 (Next.js) completed');
        } catch (method1Error: any) {
            console.error('[AGGRESSIVE-COOKIE-TEST] Method 1 failed:', method1Error);
        }
        ...
        try {
            ...
            console.log('[AGGRESSIVE-COOKIE-TEST] Method 2 (Headers) completed:', cookieHeader);
        } catch (method2Error: any) {
            console.error('[AGGRESSIVE-COOKIE-TEST] Method 2 failed:', method2Error);
        }
        ...
        testConfigs.forEach(config => {
            ...
            setCookieHeaders.push(`${config.name}=${sessionValue}-${config.name}; ${flags.join('; ')}`);
        });
